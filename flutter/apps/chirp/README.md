...
Flutter-клиент для Chirp — Twitter-подобного приложения. Работает поверх swagger-контракта (любая реализация бэкенда подходит); локально в монорепо есть пример в `../../../backend/`.
