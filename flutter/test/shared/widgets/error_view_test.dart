...
import 'package:chirp/shared/widgets/error_view.dart';
  ...
  group('ErrorView', () {
    testWidgets('отображает сообщение об ошибке', (tester) async {
      await tester.pumpWidget(_wrap(
        const ErrorView(message: 'Нет соединения'),
      ));
    ...
    testWidgets('отображает иконку ошибки', (tester) async {
      await tester.pumpWidget(_wrap(
        const ErrorView(message: 'Ошибка'),
      ));

      expect(find.byIcon(Icons.error_outline), findsOneWidget);
    });

    testWidgets('без onRetry — кнопка "Повторить" не отображается', (tester) async {
      await tester.pumpWidget(_wrap(
        const ErrorView(message: 'Ошибка'),
      ));
    ...
    testWidgets('с onRetry — кнопка "Повторить" отображается', (tester) async {
      await tester.pumpWidget(_wrap(
        ErrorView(message: 'Ошибка', onRetry: () {}),
      ));
    ...
    testWidgets('нажатие "Повторить" вызывает onRetry', (tester) async {
      ...
      await tester.pumpWidget(_wrap(
        ErrorView(message: 'Ошибка', onRetry: () => tapped = true),
      ));
