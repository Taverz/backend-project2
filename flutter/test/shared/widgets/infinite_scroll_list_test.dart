...
void main() {
  group('InfiniteScrollList', () {
    ...
    testWidgets('isLoadingMore=true показывает индикатор загрузки', (tester) async {
      await tester.pumpWidget(_buildList(
        items: ['item1'],
        onLoadMore: () {},
        isLoadingMore: true,
    ...
    testWidgets('onLoadMore не вызывается при hasMore=false и скролле', (tester) async {
      int calls = 0;
    ...
    testWidgets('onLoadMore не вызывается пока isLoadingMore=true', (tester) async {
      int calls = 0;
